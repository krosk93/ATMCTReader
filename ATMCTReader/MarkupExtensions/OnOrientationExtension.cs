...
using ATMCTReader.Sources;
using CommunityToolkit.Mvvm.Messaging;

namespace ATMCTReader.MarkupExtensions;
...
public class OnOrientationExtension : IMarkupExtension<BindingBase>
{
    ...
    {   
        ...
        var orientationSource = new OnOrientationSource { DefaultValue = typeConverter?.ConvertFromInvariantString((string?)Default ?? string.Empty) ?? Default };
